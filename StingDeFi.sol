...
contract StingDeFi is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Sting DeFi';
    string  private constant _SYMBOL = 'SDFI';
    ...
    uint256 private constant _MAX_TX_SIZE = 20000 * _DECIMALFACTOR;
